...
const quint8 CODEPAGE_BIG5 = 0x78;
const quint8 CODEPAGE_SHIFT_JIS = 0x7B;
...
{
    //读写模式下修改文件，只读模式下修改读取编码
    if(m_tableFile.isWritable()){
        ...
        case QDbfTable::Big5:
            byte = CODEPAGE_BIG5;
            break;
        case QDbfTable::Shift_JIS:
            byte = CODEPAGE_SHIFT_JIS;
            break;
        default:
            return false;
        }
...
void QDbfTablePrivate::setTextCodec()
{
    ...
    case QDbfTable::GB18030:
        ...
        break;
    case QDbfTable::Big5:
        m_textCodec = QTextCodec::codecForName("Big5");
        break;
    case QDbfTable::Shift_JIS:
        m_textCodec = QTextCodec::codecForName("Shift-JIS");
        break;
    default:
        m_textCodec = QTextCodec::codecForLocale();
        break;
